...
{
    public static Task<AVState> GetStateAsync(
        IAsyncQueryHandler<AVGetStateQuery, AVState> handler,
        string deviceId, CancellationToken cancellationToken, bool detailed) =>
        handler.ExecuteAsync(new(deviceId, detailed), cancellationToken);

    public static Task SetStateAsync(
    ...
    public static Task<AVPosition> GetPositionAsync(
        IAsyncQueryHandler<AVGetPositionQuery, AVPosition> handler,
        string deviceId, CancellationToken cancellationToken, bool detailed) =>
        handler.ExecuteAsync(new(deviceId, detailed), cancellationToken);

    public static Task SeekAsync(
    ...
    public static Task<RCVolumeState> GetVolumeAsync(
        IAsyncQueryHandler<RCGetVolumeQuery, RCVolumeState> handler,
        string deviceId, CancellationToken cancellationToken, bool detailed) =>
        handler.ExecuteAsync(new(deviceId, detailed), cancellationToken);

    public static Task SetVolumeAsync(
    ...
    public static Task<bool?> GetMuteAsync(
        IAsyncQueryHandler<RCGetMuteQuery, bool?> handler,
        string deviceId, CancellationToken cancellationToken) =>
        handler.ExecuteAsync(new(deviceId), cancellationToken);

    public static Task SetMuteAsync(
