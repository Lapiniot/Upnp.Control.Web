...
namespace Upnp.Control.DataAccess.CompiledModels
{
    ...
    public partial class PushNotificationSubscriptionEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            endpoint.SetSetter(
                PushNotificationSubscription (PushNotificationSubscription instance, Uri value) =>
                {
                    PushNotificationSubscriptionUnsafeAccessors.Endpoint(instance) = value;
                    return instance;
                });
            ...
            endpoint.SetAccessors(
                Uri (IInternalEntry entry) => PushNotificationSubscriptionUnsafeAccessors.Endpoint(((PushNotificationSubscription)(entry.Entity))),
                Uri (IInternalEntry entry) => PushNotificationSubscriptionUnsafeAccessors.Endpoint(((PushNotificationSubscription)(entry.Entity))),
                Uri (IInternalEntry entry) => entry.ReadOriginalValue<Uri>(endpoint, 0),
                Uri (IInternalEntry entry) => ((InternalEntityEntry)entry).ReadRelationshipSnapshotValue<Uri>(endpoint, 0));
            ...
            authKey.SetSetter(
                PushNotificationSubscription (PushNotificationSubscription instance, byte[] value) =>
                {
                    PushNotificationSubscriptionUnsafeAccessors.AuthKey(instance) = value;
                    return instance;
                });
            ...
            authKey.SetAccessors(
                byte[] (IInternalEntry entry) => PushNotificationSubscriptionUnsafeAccessors.AuthKey(((PushNotificationSubscription)(entry.Entity))),
                byte[] (IInternalEntry entry) => PushNotificationSubscriptionUnsafeAccessors.AuthKey(((PushNotificationSubscription)(entry.Entity))),
                byte[] (IInternalEntry entry) => entry.ReadOriginalValue<byte[]>(authKey, 1),
                byte[] (IInternalEntry entry) => entry.GetCurrentValue<byte[]>(authKey));
            ...
            created.SetSetter(
                PushNotificationSubscription (PushNotificationSubscription instance, DateTimeOffset value) =>
                {
                    PushNotificationSubscriptionUnsafeAccessors.Created(instance) = value;
                    return instance;
                });
            ...
            created.SetAccessors(
                DateTimeOffset (IInternalEntry entry) => PushNotificationSubscriptionUnsafeAccessors.Created(((PushNotificationSubscription)(entry.Entity))),
                DateTimeOffset (IInternalEntry entry) => PushNotificationSubscriptionUnsafeAccessors.Created(((PushNotificationSubscription)(entry.Entity))),
                DateTimeOffset (IInternalEntry entry) => entry.ReadOriginalValue<DateTimeOffset>(created, 2),
            ...
            p256dhKey.SetSetter(
                PushNotificationSubscription (PushNotificationSubscription instance, byte[] value) =>
                {
                    PushNotificationSubscriptionUnsafeAccessors.P256dhKey(instance) = value;
                    return instance;
                });
            ...
            p256dhKey.SetAccessors(
                byte[] (IInternalEntry entry) => PushNotificationSubscriptionUnsafeAccessors.P256dhKey(((PushNotificationSubscription)(entry.Entity))),
                byte[] (IInternalEntry entry) => PushNotificationSubscriptionUnsafeAccessors.P256dhKey(((PushNotificationSubscription)(entry.Entity))),
                byte[] (IInternalEntry entry) => entry.ReadOriginalValue<byte[]>(p256dhKey, 3),
                byte[] (IInternalEntry entry) => entry.GetCurrentValue<byte[]>(p256dhKey));
            ...
            type.SetSetter(
                PushNotificationSubscription (PushNotificationSubscription instance, NotificationType value) =>
                {
                    PushNotificationSubscriptionUnsafeAccessors.Type(instance) = value;
                    return instance;
                });
            ...
            type.SetAccessors(
                NotificationType (IInternalEntry entry) => PushNotificationSubscriptionUnsafeAccessors.Type(((PushNotificationSubscription)(entry.Entity))),
                NotificationType (IInternalEntry entry) => PushNotificationSubscriptionUnsafeAccessors.Type(((PushNotificationSubscription)(entry.Entity))),
                NotificationType (IInternalEntry entry) => entry.ReadOriginalValue<NotificationType>(type, 4),
        ...
        public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
        {
            ...
            runtimeEntityType.SetOriginalValuesFactory(
                ...
                {
                    var structuralType = ((PushNotificationSubscription)(source.Entity));
