...
import { DeviceContainer, DeviceListContainer, ViewMode as DevicesViewMode } from "./DeviceList";
...
export default ({ match: { path, params: { category } }, deviceTemplate = DeviceCard, children, listViewMode }: DeviceRouterProps) => <>
