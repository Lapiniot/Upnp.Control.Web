...
public record PLCreateFromFilesCommand(string DeviceId, IEnumerable<IFileSource> Files, string Title, bool? Merge, bool? UseProxy);
...
public record PLAddPlaylistFilesCommand(string DeviceId, string PlaylistId, IEnumerable<IFileSource> Files, bool? UseProxy);
