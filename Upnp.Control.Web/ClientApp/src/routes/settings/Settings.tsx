        ...
        <ul className="list-group list-group-flush container-max-md no-font-boost">
            ...
            <li className="list-group-item">
                ...
                <div className="d-grid grid-1fr-auto g-3 mt-2 align-items-center">
                    ...
                    <FlagEditor caption="Use DLNA proxy" className="sp-2" checked={$s.get("useDlnaProxy")} callback={setUseProxy} context={undefined} />
                </div>
            </li>
            <li className="list-group-item">
                <small>In-app notifications</small>
                <div className="d-grid grid-1fr-auto g-3 mt-2">
                    <FlagEditor caption="Device discovery" className="sp-2" checked={$s.get("showDiscoveryNotifications")} callback={setShowDiscoveryNotifications} context={undefined} />
                    <FlagEditor caption="Playback state changes" className="sp-2" checked={$s.get("showPlaybackNotifications")} callback={setShowPlaybackNotifications} context={undefined} />
                </div>
            </li>
            {("serviceWorker" in navigator) && ("PushManager" in window) &&
                <li className="list-group-item">
                    <small>Push notifications</small>
                    <div className="d-grid grid-1fr-auto g-3 mt-3">
