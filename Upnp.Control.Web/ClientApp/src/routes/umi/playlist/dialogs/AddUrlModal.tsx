    ...
    render() {
        ...
        return <Modal title="Provide url for media feed" onSubmit={this.onSubmit} immediate {...other}>
            <div className="input-group has-validation mb-3">
                ...
                <input tabIndex={2} type="url" defaultValue={feedUrl} className="form-control" name="feed-url" placeholder="[feed url]" pattern="http(s?)://.*" required
            ...
            <div className="input-group mb-3">
                ...
                <input tabIndex={3} type="text" defaultValue={feedTitle} className="form-control" name="feed-title" placeholder="[feed title]"
